# ==============================================================================
# [SUPERSEDED] Power analysis for excluding high psi
# ==============================================================================
#
# This v3 script has been superseded by code/psi_identifiability.R, which uses
# the shared likelihood machinery in code/psi_likelihood.R and runs the
# per-pathogen calibration, ascertainment sweep, and incubation
# misspecification analyses. The v3 file is kept here only for reference.
#
