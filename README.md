...
- `make_extended_data.R` consumes the per-panel plot objects stashed by `save_fig()` during the run, composites them into the Nature-formatted Extended Data figures under `figures/ExtendedData/`, and copies each into the manuscript figures directory
